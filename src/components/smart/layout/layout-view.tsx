...
const Layout: FunctionComponent<{}> = () => {
  ...
  const layoutServiceState = useSnapshot(viewModel.layoutServiceState);

  return (
    <div className="flex flex-col h-full overflow-hidden">
      <Transition.Root show={layoutServiceState.showSideBar} as={Fragment}>
        <Dialog
          as="div"
          className="fixed inset-0 z-40 flex lg:hidden"
          onClose={() => viewModel.setShowSideBar(true)}
        >
          <Transition.Child
            as={Fragment}
              ...
              >
                <div className="absolute top-0 right-0 pt-2 -mr-12">
                  <button
                    ...
                    onClick={() => viewModel.setShowSideBar(false)}
                  >
        ...
        <div className="flex flex-col h-full lg:flex-1">
          ...
          <div className="sticky top-0 z-10 flex flex-shrink-0 h-16 border-b bg-bg-l dark:bg-bg-d border-b-l dark:border-b-d">
            <button
              ...
              onClick={() => viewModel.setShowSideBar(true)}
            >
